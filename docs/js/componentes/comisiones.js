  ...
  document.getElementById('contenido').innerHTML = `
              ...
              <div class="controls">
                <div class="control-filtros">
                  ...
                  <option value="comision_asesor">COMISION ASESOR</option>
                  <option value="comision_supervisor">COMISION SUPERVISOR</option>
                  <option value="comision_gerente">COMISION GERENTE</option>
